...
parser.add_argument('-t','--template' ,help='Base to construct filename, default=generated-conf-',default='generated-conf-')
...
for device in data:
	...
	confFile = open(options.base+str(device['mxRef'])+'.conf','w')
